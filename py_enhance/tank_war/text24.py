...
class Tank(BaseIem):
    def __init__(self, left, top):
        # 加载图片路径
        self.images = {
            'U': pygame.image.load('img/fengU.jpg'),
            'D': pygame.image.load('img/fengD.png'),
            'L': pygame.image.load('img/fengL.png'),
            'R': pygame.image.load('img/fengR.png')
        }
        self.direction = 'U'
...
class Bullet(BaseIem):
    def __init__(self, tank):
        # 图片
        self.image = pygame.image.load('img/feng.jpg')
        # 方向(坦克方向)
